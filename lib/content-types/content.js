...
Content.prototype.getLibraryNamesToLoad = function() {
  if (!this.libraries) {
    this.libraries = [];
    this.libraries = this.libraries.concat(this.content_manager.site.configuration.libraries_load || []);
    this.libraries = this.libraries.concat(this.content_manager.site.getThemeInfo().libraries_load || []);
...
Content.prototype.getHead = function() {
  return this.content_manager.site.getLibraryManager().print(this.getLibraryNamesToLoad(), 'head');
};

Content.prototype.getFooter = function() {
  return this.content_manager.site.getLibraryManager().print(this.getLibraryNamesToLoad(), 'footer');
};
