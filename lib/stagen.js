...
Site.prototype.init = function() {
  ...
  this.configuration = _.extend(
    ...
    {output_dir: '_site', content_dir: '_content', cache_dir: '_cache'}
  );
};
...
//   var that = this;
//   var content_dir = this.getContentDir();
//
...
//       catch(e) {
//         that.addError();
//         console.log("Content generation failed for " + item);
//       }
//
//     }
//   });
...
var Post = function(site, content_manager, post, options) {
  this.site = site;
