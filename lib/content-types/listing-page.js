 ...
 */
class ListingPage extends Content {
  ...
  generate() {
    ...
    this.content_manager.subscribeContentType(this.filename, this.data.listing_item.type);
  }
  getDefaultTemplate() {
    var template_string = '<div>{{page.body}}</div>\
<div>\
