...
Content.prototype.prepareLibraryMnager = function() {
  if (!this.lm) {
    this.lm = new LibraryManager(this.content_manager.site);
    if (this.data.libraries) {
      this.lm.addLibraries(this.data.libraries);
    }
  }
};

Content.prototype.getHead = function() {
  this.prepareLibraryMnager();
  return this.lm.print('head');
};

Content.prototype.getFooter = function() {
  this.prepareLibraryMnager();
  return this.lm.print('footer');
};
